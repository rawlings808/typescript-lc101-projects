...
var mySpaceShuttle = new Spacecraft('Percy', 17500);
console.log("".concat(mySpaceShuttle.name, " would take ").concat(mySpaceShuttle.getDaysToLocation(kilometersToTheMoon), " days to get to the moon."));
// Move your output statements from part 3 here. Update the template literals use the
// instance of the class.
// Part 5: Export and Import the SpaceLocation Class
// Add the required import statement BEFORE the part 1 concent.
// Add the printDaysToLocation function to the Spacecraft class.
var spaceShuttle = new Spacecraft('Gibson', 17500);
